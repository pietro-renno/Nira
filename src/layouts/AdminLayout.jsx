...
export default function AdminLayout() {
  ...
  const manageLinks = [
    { name: 'Conteúdos', path: '/admin/conteudos', icon: <FileText size={18} /> },
    { name: 'Usuários & Profissionais', path: '/admin/usuarios', icon: <Users size={18} /> },
    { name: 'Mapa / Equipes', path: '/admin/mapa', icon: <MapIcon size={18} /> },
    { name: 'Atendimentos', path: '/admin/atendimentos-chat', icon: <MessagesSquare size={18} /> },
  ];
